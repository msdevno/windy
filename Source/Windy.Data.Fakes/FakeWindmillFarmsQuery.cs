...
namespace Windy.Data.Fakes
{
    public class FakeWindmillFarmsQuery : IWindmillFarmsQuery
    {
        public IEnumerable<WindmillFarm> GetAll()
        {
            ...
            return new List<WindmillFarm> {
                new WindmillFarm { Id = 1, Name="Egersund Kommune", Windmills= new List<Windmill> {
                ...
                new WindmillFarm { Id = 2, Name="Karmøy Kommune", Windmills= new List<Windmill> {
                ...
                new WindmillFarm { Id = 3, Name="Måløy Kommune", Windmills= new List<Windmill> {
                ...
                new WindmillFarm { Id = 4, Name="Havøya Kommune", Windmills= new List<Windmill> {
                ...
                new WindmillFarm { Id = 5, Name="Røst Kommune", Windmills= new List<Windmill> {
                ...
                new WindmillFarm { Id = 6, Name="Løvund Kommune", Windmills= new List<Windmill> {
                ...
                new WindmillFarm { Id = 7, Name="Andenes Kommune", Windmills= new List<Windmill> {
